 ...
 */
NSString * const WXAppId = @"wx4868b35061f87885";
/**
 * 微信开放平台和商户约定的支付密钥
 *
 * 注意：不能hardcode在客户端，建议genSign这个过程由服务器端完成
 */
NSString * const WXAppKey = @"64020361b8ec4c99936c0e3999a9f249";
 ...
 * 注意：不能hardcode在客户端，建议genSign这个过程由服务器端完成
 */
NSString * const WXAppSecret = @"64020361b8ec4c99936c0e3999a9f249";
...
- (void)getAccessToken
{
   ...
   __weak WeixinPayHelper *weakSelf = self;
    ...
    [self.request POST:getAccessTokenUrl parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        NSError *error = nil;
...
//        
//        NSURL *zoneUrl = [NSURL URLWithString:getAccessTokenUrl];
//        
